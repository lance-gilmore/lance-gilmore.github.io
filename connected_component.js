...
export default {
  ...
  setup(props) {
    ...
    sensorReadingsInit.rand = Math.random()

    const deviceReader = new NXTDeviceReader(props.connection, sensorReadingsInit)
    ...
    let sensorReadings = ref(sensorReadingsInit)
